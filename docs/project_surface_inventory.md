...
| `src/kd_sensing/data/` | MMW prepared sequence、image/radar/gps/lidar transform、temporal missing |
| `src/kd_sensing/engine/` | train/evaluate、MMW dataloader、checkpoint、T2 extension |
