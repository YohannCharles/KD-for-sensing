...
主 agent 可以在用户明确要求审计、triage、surface review 或 literature scout 时临时采用这些角色说明。若未来把角色做成工具专属 agent、skill 或 subagent 文件，必须继续引用本文件、`AGENTS.md`、`docs/agent_navigation.md` 和对应 OpenSpec capability。
...
| `surface-auditor` | 阅读 architecture/CLI/config guardrail warning | focused test 输出、`docs/project_surface_inventory.md`、`docs/agent_navigation.md`、OpenSpec specs | inventory/guardrail 收口建议 |
