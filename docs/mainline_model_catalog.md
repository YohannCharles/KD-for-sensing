...
| `mmw-town-gps-v2` | MMW current supporting dataset workflow | `kd_sensing.engine.mmw_town_gps_v2` | `configs/mmw_town_gps_adapter_v2.yaml` | `protected MMW` | `CLAIM-MMW-GPS-V2-PENDING` |
