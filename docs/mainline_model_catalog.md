...
| `overnight-branch-router-v2` | 已归档结果的复盘入口 | `scripts/launch_overnight_branch_router_v2.py`, `scripts/summarize_overnight_branch_router_v2.py` | generated configs under ignored outputs | `supporting / historical result context` | `CLAIM-OVERNIGHT-BRANCH-ROUTER-V2` |
