...
input fields from the modality contract. When adding a modality, update `kd_sensing.modalities` first,
then add dataset columns/readers, batch preparation, model registration, diagnostic rendering, and focused
tests.
