...
先读 `openspec/specs/canonical-config-resolution/spec.md` 与 `openspec/specs/t2-baseline-surface/spec.md`。DeepSense6G 仅允许整数 Scene31–34 和四模态 64 类 T2 配置；退役 YAML 直接不存在，不添加替代 recipe、fallback 或迁移层。
