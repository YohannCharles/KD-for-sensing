...
这里仅为 MMW T2/baseline 提供按任务加载的短上下文。权威仍是 `AGENTS.md`、README、current OpenSpec、active change 与 `docs/project_surface_inventory.md`。
...
| `data` | `data.md` | MMW 四模态数据、batch、预处理 |
| `config` | `configs.md` | `configs/mmw/` recipe 与解析 |
...
| `claims` | `claims.md` | MMW evidence 与 claim 边界 |
