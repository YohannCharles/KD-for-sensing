...
| diagnostics | current/supporting | `docs/agent_context/diagnostics.md` | `src/kd_sensing/diagnostics/` | `conda run -n kd_mm_beam pytest tests/test_run_index.py tests/test_runtime_artifact_cleanup.py -q` | historical JEPA diagnostics retired |
