...
public CLI 只有 `kd-sensing-train`、`kd-sensing-evaluate`、`kd-sensing-preprocess`。`scripts/` 只保留服务 MMW all-weather、T2 screening、BPA/CMA 与 summary 的本地 helper，不能变成额外 public CLI。
