# scenes31-34-subset-reliability-validation Specification

## Purpose
定义 Scene31-34 subset reliability quick validation 的本地手工 runner、fresh eval 和 summary 输出边界。该 capability 只支撑多场景 sanity check 与历史 seed1 读取，不替代当前 Scene31-34 main missing-modality workflow，也不推广 reliability fusion、PatternFiLM 或其它支线为论文主实验。
