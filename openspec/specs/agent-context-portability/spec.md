# agent-context-portability Specification

## Purpose
定义跨 Codex、Claude Code、Cursor、GitHub Copilot、Kiro 和其它 agent 工具共享项目上下文的薄适配契约，包括当前研究简报、记忆候选、只读角色和防漂移验证；权威仍在 `AGENTS.md`、导航文档、scoped context 与 OpenSpec specs。
## Requirements
