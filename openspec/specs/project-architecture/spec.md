...
- **AND** inventory MUST 记录第二梯队热点清单，至少包含 `models/fusion/hist_beam.py`、`diagnostics/run_index.py`、`diagnostics/viewer_manifest.py`、`data/transform_ops/csi.py`、`engine/batch.py` 和 `engine/evaluation_pass.py`
