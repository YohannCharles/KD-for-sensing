...
- 新增 MMW T2 超参数开发筛选矩阵：固定 15 个场景天气域、40 epoch、epoch-40 `last.pth` 和现有 T2 结构，仅改变预注册的 BPA、temporal mask、优化日程、superset KL 或 teacher 权重。
...
- 读取 `outputs/mmw_all_weather_h5p1_seed1_v2/T2/` 作为基线配置来源；新 YAML、日志、checkpoint、评估结果均写入 ignored `outputs/`。
