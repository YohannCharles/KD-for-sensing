...
- [ ] 4.4 运行 `openspec validate add-mmw-trajectory-disjoint-protocol --strict`、`make verify-quick` 和 compile 检查
- [ ] 4.5 确认 GPU 0--3 无其他用户进程后启动 M0--M3，监控至完成并生成 validation-only 最终分析
