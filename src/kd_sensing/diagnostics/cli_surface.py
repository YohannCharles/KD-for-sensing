...
PUBLIC_CLI_SURFACE: dict[str, PublicCli] = {
    ...
    "kd-sensing-training-throughput": PublicCli(
        "kd_sensing.cli.training_throughput:main",
        "current_diagnostic",
        "kd_sensing.engine.training_io_profile",
        "training IO profile and parallel recommendation workflow",
        "stdout, ignored outputs/analysis/, or explicit output path",
        "conda run -n kd_mm_beam pytest tests/test_training_io_workflow.py tests/test_parallel_training_recommendations.py tests/test_cli_help.py -q",
        "--mode",
    ),
