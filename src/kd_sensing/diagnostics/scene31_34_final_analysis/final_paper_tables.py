...
from kd_sensing.diagnostics.scene31_34_final_analysis import main_paper_tables as base_tables
from kd_sensing.diagnostics.scene31_34_final_analysis.common import read_csv, write_md_table
