...
from kd_sensing.engine.deepsense6g_residual_fusion import compare_deepsense6g_residual_with_gps_v2


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Compare DeepSense6G residual fusion with GPS v2 baselines.")
    parser.add_argument("--gps-v2-root", default="outputs/analysis/deepsense6g_gps_adapter_v2_support_sweep")
    parser.add_argument("--residual-root", default="outputs/analysis/deepsense6g_residual_fusion/r15/mapping_disabled")
...
def run_main(argv: list[str] | None = None) -> dict[str, Any]:
    ...
    return compare_deepsense6g_residual_with_gps_v2(
