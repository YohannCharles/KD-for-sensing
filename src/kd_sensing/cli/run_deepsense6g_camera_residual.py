...
from kd_sensing.engine.deepsense6g_camera_residual import run_deepsense6g_camera_residual


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run DeepSense6G camera residual train/eval workflow.")
...
def run_main(argv: list[str] | None = None) -> dict[str, Any]:
    ...
    return run_deepsense6g_camera_residual(
        cfg,
