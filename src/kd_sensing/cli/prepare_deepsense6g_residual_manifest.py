...
from kd_sensing.data.deepsense6g_residual import build_residual_manifest


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Prepare DeepSense6G residual fusion manifest.")
...
def run_main(argv: list[str] | None = None) -> dict[str, Any]:
    ...
    return build_residual_manifest(
        cfg,
