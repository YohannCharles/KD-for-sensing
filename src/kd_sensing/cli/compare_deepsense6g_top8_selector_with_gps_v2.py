...
from kd_sensing.engine.deepsense6g_top8_selector import compare_deepsense6g_top8_selector_with_gps_v2


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Compare DeepSense6G Top8 selector with GPS v2 baselines.")
    parser.add_argument("--gps-v2-root", default="outputs/analysis/deepsense6g_gps_adapter_v2_support_sweep")
    parser.add_argument("--selector-root", default="outputs/analysis/deepsense6g_top8_selector/r15/mapping_disabled")
...
def run_main(argv: list[str] | None = None) -> dict[str, Any]:
    ...
    return compare_deepsense6g_top8_selector_with_gps_v2(
