...
RETAINED_SCRIPTS = {
    ...
    "eval_pgcd_quick_search.py",
    "eval_quick_pcer_validation.py",
    "eval_pcer_direction_search.py",
    "eval_quick_pcer_diagnostics.py",
    "eval_deepsense_twc_evidence.py",
    "eval_deepsense_router_falsification.py",
    ...
    "launch_mmw_dynamic_router_decision_screen.py",
    "launch_mmw_h2r_simplification_screen.py",
    ...
    "run_mmw_dynamic_router_decision_evaluation_after_training.py",
    "run_mmw_h2r_simplification_evaluation_after_training.py",
    "run_quick_pcer_validation.py",
    "run_pgcd_quick_search.py",
    "run_pcer_direction_search.py",
