...
def build_demo(samples: list[dict[str, Any]], status: str | None = None, *, profile_render: bool = False):
    try:
        import gradio as gr
...
def main(argv: list[str] | None = None) -> dict[str, Any]:
    ...
    demo = build_demo(samples, status=status, profile_render=bool(args.profile_render))
    result = {
        "status": "complete",
