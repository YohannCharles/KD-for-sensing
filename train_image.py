...
def parse_args():
    ...
    parser.add_argument('--teacher_model_name', type=str, default='ImageTeacher_best.pth', help='Name of teacher model')
...
def main():
    ...
    # student_model = ImageStudentModalityNet(args.feature_size, args.num_classes, GRU_PARAMS_student)
    student_model = ImageModalityNet(args.feature_size, args.num_classes, GRU_PARAMS_teacher)
